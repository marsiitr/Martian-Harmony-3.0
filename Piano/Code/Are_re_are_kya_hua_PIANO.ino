...
int stepInitR=5;  // stepper initial position .
int solenoidPin6 = 23, solenoidPin7 = 25  , solenoidPin8 = 27 ,   solenoidPin9 =  29 ,  solenoidPin10 = 31;
int stepPerKeyR=57; // As the Name specifys how many steps should be taken to reach the very next key.
...
int step_CR=0,step_DR=0,step_ER=2,step_FR=2,step_GR=2,step_AR=5,step_BR=5,stepC_mazor=00;
int step_cR=5,step_dR=5,step_eR=5,step_fR=6,step_gR=7,step_aR=9,step_bR=9;


int Y=sizeof(notePianoR);
int iPianoR=0;
// initializing steppers
Stepper stepperR(STEPPOS, 9,10,11,12);
...
analogWrite(8,0);// Stepper R
analogWrite(13,0);


  stepperR.setSpeed(100);// stepper speed is set to 100.
