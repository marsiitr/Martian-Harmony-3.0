...
void newNoteR(){
     ...
     if (prevFlag6==currFlag6&&currFlag6==1)        {   digitalWrite(solenoidPin6, LOW); prevFlag6=0; delay(30);}
   
    if (prevFlag7==currFlag7&&currFlag7==1)         {   digitalWrite(solenoidPin7, LOW); prevFlag7=0; delay(30);}
   
    if (prevFlag8==currFlag8&&currFlag8==1)         {   digitalWrite(solenoidPin8, LOW); prevFlag8=0; delay(30);}
    
    if (prevFlag9==currFlag9&&currFlag9==1)         {   digitalWrite(solenoidPin9, LOW); prevFlag9=0; delay(30);}
    
    if (prevFlag10==currFlag10&&currFlag10==1)       {   digitalWrite(solenoidPin10, LOW); prevFlag10=0; delay(30);}
